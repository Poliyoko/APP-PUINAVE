...
$EvidenceRoot = "artifacts/development/SGODA-InstitutionalMasterSynchronization-RECOVERY-v1.1.6"
$LargeRoot = "artifacts/institutional/master-synchronization/largefile-preservation-v1.1.6"
...
$RecoveryDoc = "docs/00_Estado_Maestro/SGODA-PUINAVE-Sincronizacion-Institucional-Maestra-RECOVERY-v1.1.6.md"
$RecoveryAct = "docs/00_Estado_Maestro/ACT-SGODA-MASTER-SYNC-RECOVERY-v1.1.6.md"
...
function Hold {
    param([string]$Reason)
    Write-Host ""
    Write-Host "SGODA MASTER SYNCHRONIZATION RECOVERY v1.1.6 : HOLD" -ForegroundColor Red
...
try {
    ...
    $DocText = @"
# SGODA-PUINAVE - Sincronizacion Institucional Maestra - RECOVERY v1.1.6
...
"@
    ...
    $ActText = @"
# ACT-SGODA-MASTER-SYNC-RECOVERY-v1.1.6
...
"@
    ...
    & git.exe commit -m "fix(institutional): finalize master synchronization recovery with canonical pytest context"
    ...
    Write-Host ""
    Write-Host "SGODA INSTITUTIONAL MASTER SYNCHRONIZATION RECOVERY v1.1.6 : CLOSED / PASS" -ForegroundColor Green
