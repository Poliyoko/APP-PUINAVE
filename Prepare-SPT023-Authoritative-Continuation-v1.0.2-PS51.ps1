...
function Stop-Prepare {
    ...
    Write-Host " SPT-023 CONTINUATION PREPARE v1.0.2 : HOLD" -ForegroundColor Red
...
try {
    ...
    Write-Host " SGODA-PUINAVE - SPT-023 AUTHORITATIVE CONTINUATION PREPARE v1.0.2" -ForegroundColor Cyan
    ...
    # IMPORTANT PS5.1: @() at CALL SITE guarantees Count=0 instead of $null.
    ...
    Write-Host " SPT-023 CONTINUATION PREPARE v1.0.2 : PASS" -ForegroundColor Green
    ...
    Stop-Prepare -Message $_.Exception.Message
}
