<#
.SYNOPSIS
    Corrige y cierra institucionalmente SPT-010 v1.0.1.
...
$CompatibilityTests = @'
"""Pruebas del correctivo SPT-010 v1.0.1."""
...
if (-not $SkipInstitutionalClosure) {
    ...
    if (-not [bool]$RoadmapValidation.passed) {
        throw "SGD-116 no aprobó el correctivo SPT-010 v1.0.1."
    }
...
Write-Host "SPT-010 v1.0.1 corregido." -ForegroundColor Green
