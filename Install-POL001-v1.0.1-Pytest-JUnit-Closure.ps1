<#
.SYNOPSIS
    Instala POL-001 v1.0.1 — Uso Preferente de Tecnologías Gratuitas
    y de Código Abierto.
...
$ArtifactDir = Join-Path $ProjectRoot "artifacts\policy\POL-001-v1.0.1"
$ReleaseDir = Join-Path $ProjectRoot "releases\POL-001-v1.0.1"
...
$Component = @'
{
  ...
  "artifacts": ["artifacts/policy/POL-001-v1.0.1"],
...
$ReleaseFiles = @(
    ...
    "artifacts\policy\POL-001-v1.0.1"
)
...
Write-Host "POL-001 v1.0.1 implementado." -ForegroundColor Green
...
Write-Host "Release: releases\POL-001-v1.0.1" -ForegroundColor Cyan
