<#
.SYNOPSIS
    Instala SGD-114E v1.0.0 — Native Ecosystem Architecture Policy.
...
$ReleaseDir = Join-Path $ProjectRoot "releases\SGD-114E-v1.0.0"
...
$Doc = @'
# SGD-114E v1.0.0 — Native Ecosystem Architecture Policy
...
$ReplacementMap = [ordered]@{
    "INTEGRADOS POR CONTRATO" = "INTEGRADOS NATIVAMENTE"
    "INTEGRADAS POR CONTRATO" = "INTEGRADAS NATIVAMENTE"
    "INTEGRADO POR CONTRATO" = "INTEGRADO NATIVAMENTE"
    "INTEGRADA POR CONTRATO" = "INTEGRADA NATIVAMENTE"
    "integrados por contrato" = "integrados nativamente"
    "integradas por contrato" = "integradas nativamente"
    "integrado por contrato" = "integrado nativamente"
    "integrada por contrato" = "integrada nativamente"
    "Contract-based Integration" = "Native Ecosystem Integration"
    "Contract Integration" = "Native Ecosystem Integration"
    "contract-based integration" = "native ecosystem integration"
    "contract integration" = "native ecosystem integration"
}
...
foreach ($RootItem in $TerminologyRoots) {
    ...
    foreach ($File in $Files) {
        ...
        foreach ($Pair in $ReplacementMap.GetEnumerator()) {
...
Write-Host "SGD-114E v1.0.0 implementado." -ForegroundColor Green
...
if (-not $SkipInstitutionalClosure) {
    ...
    Write-Host "Release: releases\SGD-114E-v1.0.0" `
