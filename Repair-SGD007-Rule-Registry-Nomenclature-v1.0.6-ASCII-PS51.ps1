...
$OldName = "SGD-007-Registro-Maestro-Reglas-Institucionales-v1.0.0.md"
...
$OldExactTokens = @(
    ...
    "SGD-007 - Registro Maestro de Reglas Institucionales",
    '"SGD-007-Registro-Maestro-Reglas-Institucionales-v1.0.0.md"',
    "'SGD-007-Registro-Maestro-Reglas-Institucionales-v1.0.0.md'"
)
...
$ReplacementPairs = @(
    ...
    [PSCustomObject]@{
        Old = "# SGD-007 - Registro Maestro de Reglas Institucionales"
