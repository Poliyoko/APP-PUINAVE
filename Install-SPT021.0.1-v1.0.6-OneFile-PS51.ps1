...
.SYNOPSIS
    ...
    Version 1.0.6 - One File - Windows PowerShell 5.1
...
.EXAMPLE
    .\Install-SPT021.0.1-v1.0.6-OneFile-PS51.ps1 -Publish

.EXAMPLE
    .\Install-SPT021.0.1-v1.0.6-OneFile-PS51.ps1 -Publish -PublishTags
#>
