<#
.SYNOPSIS
    Instala POL-001 v1.0.2 — Uso Preferente de Tecnologías Gratuitas
    y de Código Abierto.
...
$ArtifactDir = Join-Path $ProjectRoot "artifacts\policy\POL-001-v1.0.2"
$ReleaseDir = Join-Path $ProjectRoot "releases\POL-001-v1.0.2"
...
$Registry = @'
{
  ...
  "technologies": [
    ...
    },
    {
      ...
      "cost_model": "free",
      "reason": "Servidor ASGI gratuito y de código abierto.",
      "adr_required": false
    },
    {
      "name": "pydantic",
      ...
      "license": "MIT",
      "cost_model": "free",
      "reason": "Biblioteca gratuita y de código abierto para validación de datos.",
      "adr_required": false
    },
    {
      "name": "httpx",
      ...
      "license": "BSD-3-Clause",
      "cost_model": "free",
      "reason": "Cliente HTTP gratuito y de código abierto.",
      "adr_required": false
    },
    {
      "name": "openpyxl",
      ...
      "license": "MIT",
      "cost_model": "free",
      "reason": "Biblioteca gratuita y de código abierto para archivos Excel.",
      "adr_required": false
    }
  ]
}
...
$Component = @'
{
  ...
  "artifacts": ["artifacts/policy/POL-001-v1.0.2"],
...
$ReleaseFiles = @(
    ...
    "artifacts\policy\POL-001-v1.0.2"
)
...
Write-Host "POL-001 v1.0.2 implementado." -ForegroundColor Green
...
Write-Host "Release: releases\POL-001-v1.0.2" -ForegroundColor Cyan
