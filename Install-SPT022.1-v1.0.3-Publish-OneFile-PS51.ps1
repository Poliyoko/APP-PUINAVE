<#
.SYNOPSIS
SPT-022.1 v1.0.3 - Publicacion Institucional de SPT-022.
...
function ConvertTo-NativeArgument {
    ...
    # - double backslashes that precede a quote;
...
$RunRoot = Join-Path `
    $ProjectRoot `
    ("artifacts\publication\SPT-022.1-v1.0.3\runs\" + $RunId)
...
$Evidence = [ordered]@{
    ...
    powershell51_processstartinfo_arguments_compatible = $true
...
Write-Host "PowerShell 5.1 ProcessStartInfo compatibility: ENABLED"
...
Write-Host ""
Write-Host "SPT-022.1 v1.0.3: CLOSED WITH ZERO TECHNICAL ERRORS."
