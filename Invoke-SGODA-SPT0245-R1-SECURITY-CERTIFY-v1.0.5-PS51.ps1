...
$SelfName = "Invoke-SGODA-SPT0245-R1-SECURITY-CERTIFY-v1.0.5-PS51.ps1"
...
$ArtifactDir = "artifacts/development/SPT-024.5-R1-v1.0.5"
...
function Stop-Hold {
    ...
    Write-Host " SPT-024.5 R1 v1.0.5 : HOLD" -ForegroundColor Red
