...
$MasterName = "Invoke-SGODA-SPT02411-Capa3-FINAL-v1.0.1-PS51.ps1"
...
$FailedMaster = "Invoke-SGODA-SPT02411-Capa3-FINAL-v1.0.0-PS51.ps1"
...
Write-Host ""
Write-Host "SPT-024.11 : INSTITUTIONALLY CLOSED / RECOVERY CERTIFIED v1.0.1" -ForegroundColor Green
