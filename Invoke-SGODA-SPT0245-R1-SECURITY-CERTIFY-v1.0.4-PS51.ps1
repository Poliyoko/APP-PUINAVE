...
$SelfName = "Invoke-SGODA-SPT0245-R1-SECURITY-CERTIFY-v1.0.4-PS51.ps1"
...
$ArtifactDir = "artifacts/development/SPT-024.5-R1-v1.0.4"
...
function Stop-Hold {
    ...
    Write-Host " SPT-024.5 R1 v1.0.4 : HOLD" -ForegroundColor Red
