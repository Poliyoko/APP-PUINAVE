...
function Fail {
    ...
    Write-Host " SGODA RECONCILIATION v2.0.1 : HOLD" -ForegroundColor Red
...
Write-Section "SGODA-PUINAVE - TRANSACTIONAL UNTRACKED RECONCILIATION v2.0.1"
...
$InstitutionalTool = Join-Path `
    $Root `
    "tools\institutional\Invoke-SGODA-Untracked-Reconciliation-v2.0.1-PS51.ps1"
...
$EvidenceRoot = Join-Path `
    $Root `
    "artifacts\audit\untracked-reconciliation-v2.0.1"
...
Write-Host " SGODA RECONCILIATION v2.0.1 : PASS" -ForegroundColor Green
