...
$RunRoot = Join-Path $ProjectRoot (
    "artifacts\publication\SPT-021.0.1-v1.0.8\runs\" + $RunId
)
$DocsRoot = Join-Path $ProjectRoot "docs\06_Tecnologia\SPT-021.0.1"
$ReleaseRoot = Join-Path $ProjectRoot "releases\SPT-021.0.1-v1.0.8"
...
$ExpectedRunRootToken = "artifacts\publication\SPT-021.0.1-v1.0.8\runs"
$ExpectedReleaseToken = "releases\SPT-021.0.1-v1.0.8"
...
Write-Host "Persistent publication engine: SPT-021.0.1 v1.0.8"
